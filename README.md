...
<img src="README-Images/Frontend.png" alt="フロントエンド画面" width="600" />

ブラウザ上で在室状態や登録情報を確認できるフロントエンドの表示例です。
...
<img src="README-Images/Frontend.png" alt="Frontend screen" width="420" />

This is an example frontend view showing presence status and registration information in the browser.
